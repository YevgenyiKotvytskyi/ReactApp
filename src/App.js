...
const author = 'Евгений Котвицкий'

const FeaturesSliderItem = (props) => (
    <div className="features-slider_item">
    <div className="features-img" style={ { backgroundImage: props.imgLink } } > </div>
    <div className="features-feature">{ props.descr }</div>
</div>
)

const ButtonArrow = (props) => (
    <button className = {`features-slider-arrow ${props.arrowClass} }`}>
    ...
    <div>
                ...
                <div className="features-wrapper">
                    ...
                    <div className="features-slider">
                        <div className="features-slider_items">
                            <FeaturesSliderItem imgLink = 'url(./images/1.svg)' descr = 'Первое целевое преимущество' />
                            <FeaturesSliderItem imgLink = 'url(./images/2.svg)' descr = 'Второе целевое преимущество' />
                            <FeaturesSliderItem imgLink = 'url(./images/3.svg)' descr = 'Третье целевое преимущество' />
                            <FeaturesSliderItem imgLink = 'url(./images/4.svg)' descr = 'Четвертое целевое преимущество' />
                        </div>
                        <ButtonArrow arrowClass = 'features-slider-prev'/>
                        <ButtonArrow arrowClass = 'features-slider-next'/>
                    </div>
                </div>
            </div>
    	</section>
        ...
        <footer>
            <div className="footer">
                ...
                <div className="footer-websurfer"><span className="footer-websurfer_build">Сделано&nbsp;</span><a href="#" > { author } </a></div>
